...
\begin{definition}[Reset monoid]\label{def:resets}
  \lean{KRTheory.TransMon.Resets, KRTheory.TransMon.resetMonoid}\leanok
  \uses{def:transmon}
...
\begin{definition}[Flip-flop]\label{def:flipflop}
  \lean{KRTheory.TransMon.flipFlop}\leanok\uses{def:resets}
...
\begin{lemma}[Split]\label{lem:reset-split}
  \lean{KRTheory.TransMon.reset_split}\leanok
...
\begin{lemma}[DKS 2.12]\label{lem:reset-div-flipflops}
  \lean{KRTheory.TransMon.reset_div_flipFlops,
        KRTheory.TransMon.resetMonoid_div_flipFlop_of_card_one}\leanok
